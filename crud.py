...
def dict_for_day(entry: DiaryEntry) -> dict:
    ...
    return {
        ...
        "urge1 name": get_urge_desc_by_id(
            entry.urge_entries[0].urge_id),
        "urge2 name": get_urge_desc_by_id(
            entry.urge_entries[1].urge_id),
        "urge3 name": get_urge_desc_by_id(
        ...
        "action1 name": get_action_desc_by_id(
            entry.action_entries[0].action_id),
        "action2 name": get_action_desc_by_id(
